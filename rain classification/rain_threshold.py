...
if __name__ == "__main__":
    ...
    fig = plt.figure()
    plt.imshow(hist_survival+hist_landslide, origin="lower", extent=[x_edges[1], x_edges[-1], y_edges[1], y_edges[-1]], aspect="auto", cmap="Reds")
    ...
    fig = plt.figure()
    plt.imshow(hist_landslide, origin="lower", extent=[x_edges[1], x_edges[-1], y_edges[1], y_edges[-1]], aspect="auto", cmap="Reds")
    ...
    plt.imshow(landslide_ratio, origin="lower", extent=[x_edges[1], x_edges[-1], y_edges[1], y_edges[-1]], aspect="auto", cmap="Reds")
    ...
    plt.imshow(landslide_ratio.T, origin="lower", extent=[x_edges[1], x_edges[-1], y_edges[1], y_edges[-1]], aspect="auto", cmap="Reds")
